...
export const he = {
  ...
  home: {
    ...
    // Stated rather than hidden: this build carries authentication and nothing
    // else, and a dashboard of placeholder numbers would be worse than a
    // sentence saying so (docs/roadmap.md, Phase 7).
    scopeNotice:
      'בגרסה זו מיושמים ההתחברות, החלפת הסיסמה וניהול ההרשאות. מסכי אנשים, תיקים, מסמכים ולוח הבקרה נבנים בשלבים הבאים.',
  },
  apiHealth: {
    title: 'חיבור לשרת',
    checking: 'בודק…',
